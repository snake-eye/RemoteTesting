...
public class Exec extends Fragment implements ActionBar.TabListener {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			switch(position){
			case 0: fragment=new Current();break;
			case 1: fragment=new History();break;
			default: fragment=new Current();break;
			}
...
//			fragment.setArguments(args);
	...
	public static class Current extends ListFragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(R.layout.exec1,
					container, false);
			TextView msg = (TextView) rootView
					.findViewById(R.id.section_label);
			final int pid=MainActivity.pid;
			ProductRepo repo = new ProductRepo(getActivity());
	        Product product = new Product();
		    ...
		    sadd.setOnClickListener(new OnClickListener(){@Override
		    ...
		    sdone.setOnClickListener(new OnClickListener(){@Override
  	        	public void onClick(final View view) {
					if(sname.getText().toString().isEmpty()){Toast.makeText(getActivity(),"Please enter name",Toast.LENGTH_SHORT).show();}
					else{
	  					Sub sub = new Sub();
		    			...
		    			sub.sid=0;
		    				srepo.insert(sub);
		    				ListAllSub();
		    				Toast.makeText(getActivity(),"New Sub Product Inserted",Toast.LENGTH_SHORT).show();
					}
				}
  	        });
		...
		@Override
	  	...
	  	void ListAllSub(){
	        ...
	        if(items.size()!=0) {
	        	...
	        	lv.setAdapter(null);
	            Toast.makeText(getActivity(),"No Sub Products!",Toast.LENGTH_SHORT).show();
	        }
	  	}
		
	  	class PopupAdapter extends SimpleAdapter{
	  	    PopupAdapter(ArrayList<HashMap<String, String>> items) {
	  	        	super(getActivity(),items, R.layout.exec3, new String[] { "id","name"}, new int[] {R.id.sub_Id, R.id.sub_name});        
	  	    }
	  	    ...
	  	    public View getView(int position, View convertView, ViewGroup container) {
	  	        ...
	  	        View sdone1 = view.findViewById(R.id.sdone1);
	  	        ...
	  	        final EditText sname1=(EditText) view.findViewById(R.id.sname1);
	  	    	sname1.setText(sname);
	  	    	final SubRepo srepo = new SubRepo(getActivity());
		  		
	  	        sedit1.setOnClickListener(new OnClickListener(){@Override
	  	        	public void onClick(final View view) {
	  	        ...
	  	        sexec1.setOnClickListener(new OnClickListener() {@Override
	  				public void onClick(View v) {
	  	        //	((MainActivity)getActivity()).newfrag(2,pid);
	  	            }
	  	        });
	  	        
	  	        sdel1.setOnClickListener(new OnClickListener() {@Override
	  				public void onClick(View v) {
	  	        	srepo.delete(sid);
	  	  	    	Toast.makeText(getActivity(), "Sub Product Deleted", Toast.LENGTH_SHORT).show();
	  	  	    ListAllSub();
	  				}
	  	        });
	  	        
	  	      sdone1.setOnClickListener(new OnClickListener(){@Override
	  	        	public void onClick(final View view) {
						if(sname1.getText().toString().isEmpty()){Toast.makeText(getActivity(),"Please enter name",Toast.LENGTH_SHORT).show();}
						else{
		  					Sub sub = new Sub();
			    			...
			    			sub.sid=sid;
			    				srepo.update(sub);
			    				ListAllSub();
			        			Toast.makeText(getActivity(),"Sub Product Updated",Toast.LENGTH_SHORT).show();
						}
					}
	  	        });
	...
	public static class History extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
				Bundle savedInstanceState) {
			View rootView = inflater.inflate(R.layout.exec2,
					container, false);
			TextView msg = (TextView) rootView
					.findViewById(R.id.section_label);
			int id=MainActivity.pid;
